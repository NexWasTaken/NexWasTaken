...
> [!NOTE]
> Most Used Languages does not indicate my skill level; it's a GitHub metric to determine which languages I have written the most code on GitHub with. It also only doesn't count repos I had contributed to, but can no longer access now.
<!--
